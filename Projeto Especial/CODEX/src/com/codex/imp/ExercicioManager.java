...
//Buscar específico exercício por titulo
				
				public List<Exercício> getExTitulo(String titulo) {
					ExercicioData exData = ExercicioData.getInstance();
...
//Buscar específico exercício por tag
				...
				public Response removeExercise(String titulo, String userIDAuthor) {
					...
					List<Exercício> ex = ExercicioData.getInstance().getExTitulo(titulo);
					String userEx = null;
					for (Exercício exs : ex) {
